...
//  Vérification des informations d'identification de l'utilisateur ; renvoie l’id de l'utilisateur depuis la base de données et un token web JSON signé (contenant également l'_id de l'utilisateur).
